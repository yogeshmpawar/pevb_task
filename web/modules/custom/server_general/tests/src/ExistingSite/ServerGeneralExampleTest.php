...
class ServerGeneralExampleTest extends ServerGeneralTestBase {
  ...
  public function testGroup() {
    ...
    // Create a "NewGroup" article. Will be automatically cleaned up at end of
    // test.
    $node = $this->createNode([
      'title' => 'NewGroup',
      'type' => 'group',
    ...
    $this->drupalGet($node->toUrl());
    $this->assertSession()->statusCodeEquals(200);
    $this->assertSession()->statusMessageContains('if you would like to subscribe to this group called', 'status');
